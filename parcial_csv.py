...
def mostrar_insumos_con_caracteristica(insumos_con_caracteristica, caracteristica):
...
def realizar_compra(datos):
    ...
    total = 0
    while True:
        marca = input("Ingrese la marca de los insumos que desea comprar (o 'Salir' para finalizar): ")
        ...
        for producto in datos:
            if producto["marca"] == marca:
                ...
                print()
        producto_nombre = input("Ingrese el nombre del producto que desea comprar (o 'Salir' para finalizar la compra): ")
    ...
    while True:
        ...
        if opcion== 1:
            ...
            if opcion_1==True:
                ...
                mostrar_insumos_con_caracteristica(datos, caracteristica)
        elif opcion == 5:
            if opcion_1==True:
                print("primero carga los datos")
            else:
